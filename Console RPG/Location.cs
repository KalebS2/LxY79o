...
namespace Console_RPG
{
    class Location
    {
        ...
        public static Location shopKH = new Location("Shop", "Do you like hoarding gold? If yes, then why didn't you go to the ice level.", false, new Shop("Bill Gates", new List<Item>() { HealthItem.potion1, HealthItem.potion2, Map.map })); //put items in {   }
        public static Location shopOWL = new Location("Shop", "Alright there are no more contractual obligations to fulfill, except for the ice level but that was the other way.", false, new Shop("Saul Goodman", new List<Item>() { HealthItem.potion2, DefenseItem.defensePot1, StrengthItem.strengthPot1, Map.map}));
        public static Location shopMD = new Location("Shop", "Well I hope that defeating those enemies in Mount Doom was worth it.", false, new Shop("Sauron", new List<Item>() { HealthItem.potion2, DefenseItem.defensePot1, StrengthItem.strengthPot1, Map.map }));
        public static Location shopNK = new Location("Shop", "You can follow the path through the other room if you want, but remember that killing God is the main goal.", false, new Shop("Kim Jong Un", new List<Item>() { HealthItem.potion3, DefenseItem.defensePot2, StrengthItem.strengthPot2, Map.map }));
